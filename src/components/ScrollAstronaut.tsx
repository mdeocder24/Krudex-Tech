...
const ScrollAstronaut = () => {
  ...
  // useTransform maps [0, 1] input to ["5vh", "85vh"]
  const topPosition = useTransform(scrollYProgress, [0, 1], ["5vh", "85vh"]);
  
  // Map scroll progress to rotation
  const rotateTransform = useTransform(scrollYProgress, (latest) => {
    return Math.sin(latest * Math.PI * 4) * 8;
  });
