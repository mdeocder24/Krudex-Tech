...
const timelineData = [
  ...
  {
    year: "2025",
    text: "Krudex Technologies incorporated as an entity in Telangana, India."
  }
];
      ...
      <section className="px-8 md:px-16 lg:px-24 py-32 bg-krudex-black/40 backdrop-blur-md border-t border-krudex-border/50 relative z-10">
        <div className="max-w-3xl mx-auto flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.2 }}
          >
            <Link href="/contact" className="group flex items-center gap-2 bg-krudex-blue text-krudex-black px-8 py-4 font-semibold text-sm hover:bg-krudex-blue-hover transition-colors">
              Get in Touch
